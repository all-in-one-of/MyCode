# -*- encoding: utf-8 -*-
"""
@File    : superBoolTool.py
@Time    : 2019/4/10 14:25
@Author  : Intime
@Software: PyCharm
"""
...
pma.button("clean", label="Clean Up", width=120, height=40, backgroundColor=[0.2, 0.2, 0.2], parent="mainColumn",
           command="cleanUp()")
...
pma.button("triangB", label="Triangulate", width=120, height=40, backgroundColor=[0.2, 0.2, 0.2],
           parent="nameGridLayout02", command="triangulate()")
pma.button("fixMatB", label="FixMaterial", width=120, height=40, backgroundColor=[0.2, 0.2, 0.2],
           parent="nameGridLayout02", command="fixMaterial()")
################################################################################################UI#################################################
pma.showWindow()